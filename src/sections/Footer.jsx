    ...
    <footer className="max-container">
      ...
      flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          ...
          Get sunglasses ready for the new term at your nearest RayBan store. 
          Find Your perfect Style In Store. Get Rewards
          </p>
              ...
              <div key={section}>
                ...
                <ul>
                  {section.links.map((link) => (
                    <li className="mt-3 font-montserrat text-base text-white-400 leading-normal
