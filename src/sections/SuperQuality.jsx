import { glasses8 } from "../assets/images";
  ...
  return (
    ...
    >
      ...
      <h2 className="font-palanquin capitalize text-4xl font-bold lg:max-w-lg">
          We Provide You
          <span className="text-red-600 "> Super Quality</span> Sunglasses
        </h2>
      ...
      <div className="flex flex-1 justify-center items-center ">
        <img src={glasses8} alt="glasses8" width={570} height={522} className="rounded-2xl object-contain"  />
      </div>
    </section>
  )
}
